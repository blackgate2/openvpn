...
$tables['after_invent_show'] = array(
    'titles' => array('Аккаунт', 'Протокол', 'Сервер','Статус'),
    'fields' => array('name',    'proto',    'server','status'),
    'table' => 'after_invent',
    'table_view' => 'after_invent',
    'where' => '',
    ...
    'actions_pannel' => array(
        array('title' => 'Инвентаризация',
            ...
            'confirm' => ''),
        array('title' => 'Включить все на блокировку',
            'url' => 'index.php?m=main&table=' . $table.'&set_status=1',
            'action' => 'show',
