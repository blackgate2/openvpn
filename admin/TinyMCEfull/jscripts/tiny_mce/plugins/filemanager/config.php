<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../../addFilesConfig/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../../addFilesConfig/'; // absolute or relative from this script path.
